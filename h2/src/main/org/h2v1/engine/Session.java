...
import org.h2v1.command.Prepared;
...
import org.h2v1.index.ViewIndex;
...
import org.h2v1.mvstore.MVMap;
import org.h2v1.mvstore.db.MVIndex;
import org.h2v1.mvstore.db.MVTable;
import org.h2v1.mvstore.db.MVTableEngine;
import org.h2v1.mvstore.tx.Transaction;
import org.h2v1.mvstore.tx.TransactionStore;
...
import org.h2v1.value.VersionedValue;
...
public class Session extends SessionWithState implements TransactionStore.RollbackListener, CastDataProvider {
    ...
    public void removeLocalTempTable(Table table) {
        // Exception thrown in org.h2v1.engine.Database.removeMeta if line below
    ...
    private void _cleanTempTables(boolean closeSession) {
        ...
        while (it.hasNext()) {
            ...
            if (closeSession || table.getOnCommitDrop()) {
                ...
                table.setModified();
                it.remove();
                // Exception thrown in org.h2v1.engine.Database.removeMeta
    ...
    public void setIsolationLevel(IsolationLevel isolationLevel) {
        ...
        if (database.isMVStore()) {
            ...
            org.h2v1.command.dml.Set set = new org.h2v1.command.dml.Set(this, SetTypes.LOCK_MODE);
            set.setInt(lockMode);
            synchronized (database) {
                set.update();
            }
