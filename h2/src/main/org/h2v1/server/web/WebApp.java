...
import org.h2v1.bnf.Bnf;
import org.h2v1.bnf.context.DbColumn;
import org.h2v1.bnf.context.DbContents;
import org.h2v1.bnf.context.DbSchema;
import org.h2v1.bnf.context.DbTableOrView;
import org.h2v1.command.Parser;
import org.h2v1.engine.Constants;
import org.h2v1.engine.SysProperties;
import org.h2v1.jdbc.JdbcException;
import org.h2v1.message.DbException;
import org.h2v1.security.SHA256;
import org.h2v1.tools.Backup;
import org.h2v1.tools.ChangeFileEncryption;
import org.h2v1.tools.ConvertTraceFile;
import org.h2v1.tools.CreateCluster;
import org.h2v1.tools.DeleteDbFiles;
import org.h2v1.tools.Recover;
import org.h2v1.tools.Restore;
import org.h2v1.tools.RunScript;
import org.h2v1.tools.Script;
import org.h2v1.tools.SimpleResultSet;
...
import org.h2v1.util.ScriptReader;
import org.h2v1.util.SortedProperties;
...
public class WebApp {
            ...
            if (e instanceof SQLException) {
                ...
                if (isH2) {
                    ...
                    error += " <a href=\"https://h2database.com/javadoc/" +
                            "org/h2v1/api/ErrorCode.html#c" + code +
                            "\">(${text.a.help})</a>";
                }
            }
    ...
    private static String linkToSource(String s) {
        try {
            ...
            while (true) {
                int start = s.indexOf("org.h2v1.", idx);
                if (start < 0) {
