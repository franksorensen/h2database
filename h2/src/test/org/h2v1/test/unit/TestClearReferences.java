...
public class TestClearReferences extends TestBase {
    ...
    private static final String[] KNOWN_REFRESHED = {
        "org.h2v1.compress.CompressLZF.cachedHashTable",
        "org.h2v1.engine.DbSettings.defaultSettings",
        "org.h2v1.engine.SessionRemote.sessionFactory",
        "org.h2v1.expression.function.DateTimeFunctions.MONTHS_AND_WEEKS",
        "org.h2v1.expression.function.ToChar.NAMES",
        "org.h2v1.jdbcx.JdbcDataSourceFactory.cachedTraceSystem",
        "org.h2v1.store.RecoverTester.instance",
        "org.h2v1.store.fs.FilePath.defaultProvider",
        "org.h2v1.store.fs.FilePath.providers",
        "org.h2v1.store.fs.FilePath.tempRandom",
        "org.h2v1.store.fs.FilePathRec.recorder",
        "org.h2v1.store.fs.FileMemData.data",
        "org.h2v1.tools.CompressTool.cachedBuffer",
        "org.h2v1.util.CloseWatcher.queue",
        "org.h2v1.util.CloseWatcher.refs",
        "org.h2v1.util.DateTimeUtils.LOCAL",
        "org.h2v1.util.MathUtils.cachedSecureRandom",
        "org.h2v1.util.NetUtils.cachedLocalAddress",
        "org.h2v1.util.StringUtils.softCache",
        "org.h2v1.util.TimeZoneProvider.CACHE",
        "org.h2v1.util.JdbcUtils.allowedClassNames",
        "org.h2v1.util.JdbcUtils.allowedClassNamePrefixes",
        "org.h2v1.util.JdbcUtils.userClassFactories",
        "org.h2v1.util.Task.counter",
        "org.h2v1.value.CompareMode.lastUsed",
        "org.h2v1.value.Value.softCache",
        "org.h2v1.value.ValueBytes.type",
        "org.h2v1.value.ValueCollectionBase.type",
        "org.h2v1.value.ValueDecimal.type",
        "org.h2v1.value.ValueInterval.type",
        "org.h2v1.value.ValueLob.type",
        "org.h2v1.value.ValueLobDb.type",
        "org.h2v1.value.ValueString.type",
    };
     ...
     */
    private final String SOURCE_PATH = new File("h2/src/main/org/h2v1/Driver.java").exists()
    ...
    public void test() throws Exception {
        ...
        ValueInt.get(1);
        Class.forName("org.h2v1.store.fs.FileMemData");
