...
create trigger TEST_TRIGGER before insert on test call "org.h2v1.test.db.TestTriggersConstraints";
> ok
...
create linked table test_link('org.h2v1.Driver', 'jdbc:h2:mem:', 'sa', 'sa', 'DUAL');
> ok
