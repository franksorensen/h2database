...
public class AbbaDetect {
    ...
    private static String disable(String source) {
        source = source.replaceAll("\\{org.h2v1.util.AbbaDetector.begin\\(.*\\);", "{");
        source = source.replaceAll("org.h2v1.util.AbbaDetector.begin\\((.*\\(\\))\\)", "$1");
        source = source.replaceAll("org.h2v1.util.AbbaDetector.begin\\((.*)\\)", "$1");
    ...
    private static String enable(String source) {
        ...
        source = source.replaceAll("synchronized \\((.*)\\(\\)\\)",
                "synchronized  \\(org.h2v1.util.AbbaDetector.begin\\($1\\(\\)\\)\\)");
        source = source.replaceAll("synchronized \\((.*)\\)",
                "synchronized  \\(org.h2v1.util.AbbaDetector.begin\\($1\\)\\)");

        source = source.replaceAll("static synchronized ([^ (].*)\\{",
                "static synchronized  $1{org.h2v1.util.AbbaDetector.begin\\(null\\);");
        source = source.replaceAll("synchronized ([^ (].*)\\{",
                "synchronized  $1{org.h2v1.util.AbbaDetector.begin\\(this\\);");
