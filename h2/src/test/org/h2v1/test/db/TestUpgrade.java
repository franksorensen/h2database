...
import org.h2v1.upgrade.DbUpgrade;
...
public class TestUpgrade extends TestDb {
    ...
    public boolean isEnabled() {
        ...
        if (!Utils.isClassPresent("org.h2v1.upgrade.v1_1.Driver")) {
            return false;
        }
        return true;
    }
    ...
    private void testNoUpgradeOldAndNew() throws Exception {
        ...
        // Create old db
        Utils.callStaticMethod("org.h2v1.upgrade.v1_1.Driver.load");
        ...
        statNew.executeUpdate("CREATE LOCAL TEMPORARY LINKED TABLE " +
                "linkedTestOld('org.h2v1.upgrade.v1_1.Driver', 'jdbc:h2v1_1:" +
        ...
        statNew.executeUpdate("CREATE LOCAL TEMPORARY LINKED TABLE " +
                "linkedTestOld('org.h2v1.Driver', 'jdbc:h2:" +
    ...
    public void deleteDb(String dbName) {
        ...
        try {
            Utils.callStaticMethod(
                    "org.h2v1.upgrade.v1_1.tools.DeleteDbFiles.execute",
