 ...
 */
package org.h2v1.message;

import static org.h2v1.api.ErrorCode.*;
...
import org.h2v1.jdbc.JdbcSQLDataException;
import org.h2v1.jdbc.JdbcSQLException;
import org.h2v1.jdbc.JdbcSQLFeatureNotSupportedException;
import org.h2v1.jdbc.JdbcSQLIntegrityConstraintViolationException;
import org.h2v1.jdbc.JdbcSQLInvalidAuthorizationSpecException;
import org.h2v1.jdbc.JdbcSQLNonTransientConnectionException;
import org.h2v1.jdbc.JdbcSQLNonTransientException;
import org.h2v1.jdbc.JdbcSQLSyntaxErrorException;
import org.h2v1.jdbc.JdbcSQLTimeoutException;
import org.h2v1.jdbc.JdbcSQLTransactionRollbackException;
import org.h2v1.jdbc.JdbcSQLTransientException;
    ...
    static {
        try {
            byte[] messages = Utils.getResource(
                    "/org/h2v1/res/_messages_en.prop");
            if (messages != null) {
            ...
            if (!"en".equals(language)) {
                byte[] translations = Utils.getResource(
                        "/org/h2v1/res/_messages_" + language + ".prop");
