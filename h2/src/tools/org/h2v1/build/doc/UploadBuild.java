...
import org.h2v1.dev.ftp.FtpClient;
...
public class UploadBuild {
    ...
    public static void main(String... args) throws Exception {
        ...
        Connection conn;
        try {
            Class.forName("org.h2v1.Driver");
            conn = DriverManager.getConnection("jdbc:h2:mem:");
        } catch (Exception e) {
            Class.forName("org.h2v1.upgrade.v1_1.Driver");
        ...
        String newsfeed = IOUtils.readStringAndClose(
                new FileReader("src/tools/org/h2v1/build/doc/buildNewsfeed.sql"), -1);
