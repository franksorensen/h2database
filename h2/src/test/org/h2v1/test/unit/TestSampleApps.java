...
public class TestSampleApps extends TestDb {
    ...
    public void test() throws Exception {
        ...
        InputStream in = getClass().getClassLoader().getResourceAsStream(
                "org/h2v1/samples/optimizations.sql");
        ...
        testApp("", org.h2v1.tools.RunScript.class, "-url", url, "-user", "sa",
                "-password", "sa", "-script", getBaseDir() +
                        "/optimizations.sql", "-checkResults");
        deleteDb(getTestName());
        testApp("Compacting...\nDone.", org.h2v1.samples.Compact.class);
        testApp("NAME: Bob Meier\n" +
                ...
                "PHONE: +41976543210\n",
                org.h2v1.samples.CsvSample.class);
        testApp("",
                org.h2v1.samples.CachedPreparedStatements.class);
        testApp("2 is prime\n" +
                "3 is prime\n" +
                "5 is prime\n" +
                "7 is prime\n" +
                ...
                "1/1\n" +
                "10",
                org.h2v1.samples.Function.class);
        // Not compatible with PostgreSQL JDBC driver (throws a
        // NullPointerException):
        // testApp(org.h2v1.samples.SecurePassword.class, null, "Joe");
        ...
        // process)
        testApp("The sum is 20.00", org.h2v1.samples.TriggerSample.class);
        testApp("Hello: 1\nWorld: 2", org.h2v1.samples.TriggerPassData.class);
        testApp("table test:\n" +
                "1 Hallo\n\n" +
                "test_view:\n" +
                "1 Hallo",
                org.h2v1.samples.UpdatableView.class);
        testApp(
                "adding test data...\n" +
                "defrag to reduce random access...\n" +
                "create the zip file...\n" +
                "open the database from the zip file...",
                org.h2v1.samples.ReadOnlyDatabaseInZip.class);
        testApp(
                "a: 1/Hello!\n" +
                "b: 1/Hallo!\n" +
                "1/A/Hello!\n" +
                "1/B/Hallo!",
                org.h2v1.samples.RowAccessRights.class);

        // tools
        testApp("Allows changing the database file encryption password or algorithm*",
                org.h2v1.tools.ChangeFileEncryption.class, "-help");
        testApp("Deletes all files belonging to a database.*",
                org.h2v1.tools.DeleteDbFiles.class, "-help");
