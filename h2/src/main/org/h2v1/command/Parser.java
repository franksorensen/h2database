 ...
 */
package org.h2v1.command;

import static org.h2v1.util.ParserUtil.ALL;
import static org.h2v1.util.ParserUtil.ARRAY;
import static org.h2v1.util.ParserUtil.CASE;
import static org.h2v1.util.ParserUtil.CHECK;
import static org.h2v1.util.ParserUtil.CONSTRAINT;
import static org.h2v1.util.ParserUtil.CROSS;
import static org.h2v1.util.ParserUtil.CURRENT_CATALOG;
import static org.h2v1.util.ParserUtil.CURRENT_DATE;
import static org.h2v1.util.ParserUtil.CURRENT_SCHEMA;
import static org.h2v1.util.ParserUtil.CURRENT_TIME;
import static org.h2v1.util.ParserUtil.CURRENT_TIMESTAMP;
import static org.h2v1.util.ParserUtil.CURRENT_USER;
import static org.h2v1.util.ParserUtil.DISTINCT;
import static org.h2v1.util.ParserUtil.EXCEPT;
import static org.h2v1.util.ParserUtil.EXISTS;
import static org.h2v1.util.ParserUtil.FALSE;
import static org.h2v1.util.ParserUtil.FETCH;
import static org.h2v1.util.ParserUtil.FOR;
import static org.h2v1.util.ParserUtil.FOREIGN;
import static org.h2v1.util.ParserUtil.FROM;
import static org.h2v1.util.ParserUtil.FULL;
import static org.h2v1.util.ParserUtil.GROUP;
import static org.h2v1.util.ParserUtil.HAVING;
import static org.h2v1.util.ParserUtil.IDENTIFIER;
import static org.h2v1.util.ParserUtil.IF;
import static org.h2v1.util.ParserUtil.INNER;
import static org.h2v1.util.ParserUtil.INTERSECT;
import static org.h2v1.util.ParserUtil.INTERSECTS;
import static org.h2v1.util.ParserUtil.INTERVAL;
import static org.h2v1.util.ParserUtil.IS;
import static org.h2v1.util.ParserUtil.JOIN;
import static org.h2v1.util.ParserUtil.LEFT;
import static org.h2v1.util.ParserUtil.LIKE;
import static org.h2v1.util.ParserUtil.LIMIT;
import static org.h2v1.util.ParserUtil.LOCALTIME;
import static org.h2v1.util.ParserUtil.LOCALTIMESTAMP;
import static org.h2v1.util.ParserUtil.MINUS;
import static org.h2v1.util.ParserUtil.NATURAL;
import static org.h2v1.util.ParserUtil.NOT;
import static org.h2v1.util.ParserUtil.NULL;
import static org.h2v1.util.ParserUtil.OFFSET;
import static org.h2v1.util.ParserUtil.ON;
import static org.h2v1.util.ParserUtil.ORDER;
import static org.h2v1.util.ParserUtil.PRIMARY;
import static org.h2v1.util.ParserUtil.QUALIFY;
import static org.h2v1.util.ParserUtil.RIGHT;
import static org.h2v1.util.ParserUtil.ROW;
import static org.h2v1.util.ParserUtil.ROWNUM;
import static org.h2v1.util.ParserUtil.SELECT;
import static org.h2v1.util.ParserUtil.TABLE;
import static org.h2v1.util.ParserUtil.TRUE;
import static org.h2v1.util.ParserUtil.UNION;
import static org.h2v1.util.ParserUtil.UNIQUE;
import static org.h2v1.util.ParserUtil.UNKNOWN;
import static org.h2v1.util.ParserUtil.USING;
import static org.h2v1.util.ParserUtil.VALUES;
import static org.h2v1.util.ParserUtil.WHERE;
import static org.h2v1.util.ParserUtil.WINDOW;
import static org.h2v1.util.ParserUtil.WITH;
import static org.h2v1.util.ParserUtil._ROWID_;
...
import org.h2v1.api.ErrorCode;
import org.h2v1.api.IntervalQualifier;
import org.h2v1.api.Trigger;
import org.h2v1.command.ddl.AlterIndexRename;
import org.h2v1.command.ddl.AlterSchemaRename;
import org.h2v1.command.ddl.AlterSequence;
import org.h2v1.command.ddl.AlterTableAddConstraint;
import org.h2v1.command.ddl.AlterTableAlterColumn;
import org.h2v1.command.ddl.AlterTableDropConstraint;
import org.h2v1.command.ddl.AlterTableRename;
import org.h2v1.command.ddl.AlterTableRenameColumn;
import org.h2v1.command.ddl.AlterTableRenameConstraint;
import org.h2v1.command.ddl.AlterUser;
import org.h2v1.command.ddl.AlterView;
import org.h2v1.command.ddl.Analyze;
import org.h2v1.command.ddl.CommandWithColumns;
import org.h2v1.command.ddl.CreateAggregate;
import org.h2v1.command.ddl.CreateConstant;
import org.h2v1.command.ddl.CreateDomain;
import org.h2v1.command.ddl.CreateFunctionAlias;
import org.h2v1.command.ddl.CreateIndex;
import org.h2v1.command.ddl.CreateLinkedTable;
import org.h2v1.command.ddl.CreateRole;
import org.h2v1.command.ddl.CreateSchema;
import org.h2v1.command.ddl.CreateSequence;
import org.h2v1.command.ddl.CreateSynonym;
import org.h2v1.command.ddl.CreateTable;
import org.h2v1.command.ddl.CreateTrigger;
import org.h2v1.command.ddl.CreateUser;
import org.h2v1.command.ddl.CreateView;
import org.h2v1.command.ddl.DeallocateProcedure;
import org.h2v1.command.ddl.DefineCommand;
import org.h2v1.command.ddl.DropAggregate;
import org.h2v1.command.ddl.DropConstant;
import org.h2v1.command.ddl.DropDatabase;
import org.h2v1.command.ddl.DropDomain;
import org.h2v1.command.ddl.DropFunctionAlias;
import org.h2v1.command.ddl.DropIndex;
import org.h2v1.command.ddl.DropRole;
import org.h2v1.command.ddl.DropSchema;
import org.h2v1.command.ddl.DropSequence;
import org.h2v1.command.ddl.DropSynonym;
import org.h2v1.command.ddl.DropTable;
import org.h2v1.command.ddl.DropTrigger;
import org.h2v1.command.ddl.DropUser;
import org.h2v1.command.ddl.DropView;
import org.h2v1.command.ddl.GrantRevoke;
import org.h2v1.command.ddl.PrepareProcedure;
import org.h2v1.command.ddl.SchemaCommand;
import org.h2v1.command.ddl.SequenceOptions;
import org.h2v1.command.ddl.SetComment;
import org.h2v1.command.ddl.TruncateTable;
import org.h2v1.command.dml.AlterTableSet;
import org.h2v1.command.dml.BackupCommand;
import org.h2v1.command.dml.Call;
import org.h2v1.command.dml.CommandWithValues;
import org.h2v1.command.dml.DataChangeStatement;
import org.h2v1.command.dml.Delete;
import org.h2v1.command.dml.ExecuteImmediate;
import org.h2v1.command.dml.ExecuteProcedure;
import org.h2v1.command.dml.Explain;
import org.h2v1.command.dml.Insert;
import org.h2v1.command.dml.Merge;
import org.h2v1.command.dml.MergeUsing;
import org.h2v1.command.dml.NoOperation;
import org.h2v1.command.dml.Query;
import org.h2v1.command.dml.RunScriptCommand;
import org.h2v1.command.dml.ScriptCommand;
import org.h2v1.command.dml.Select;
import org.h2v1.command.dml.SelectOrderBy;
import org.h2v1.command.dml.SelectUnion;
import org.h2v1.command.dml.Set;
import org.h2v1.command.dml.SetSessionCharacteristics;
import org.h2v1.command.dml.SetTypes;
import org.h2v1.command.dml.TableValueConstructor;
import org.h2v1.command.dml.TransactionCommand;
import org.h2v1.command.dml.Update;
import org.h2v1.constraint.ConstraintActionType;
import org.h2v1.engine.Constants;
import org.h2v1.engine.Database;
import org.h2v1.engine.DbObject;
import org.h2v1.engine.Domain;
import org.h2v1.engine.FunctionAlias;
import org.h2v1.engine.IsolationLevel;
import org.h2v1.engine.Mode;
import org.h2v1.engine.Mode.ModeEnum;
import org.h2v1.engine.Procedure;
import org.h2v1.engine.Right;
import org.h2v1.engine.Session;
import org.h2v1.engine.User;
import org.h2v1.engine.UserAggregate;
import org.h2v1.expression.Alias;
import org.h2v1.expression.BinaryOperation;
import org.h2v1.expression.BinaryOperation.OpType;
import org.h2v1.expression.ConcatenationOperation;
import org.h2v1.expression.Expression;
import org.h2v1.expression.ExpressionColumn;
import org.h2v1.expression.ExpressionList;
import org.h2v1.expression.ExpressionWithFlags;
import org.h2v1.expression.Format;
import org.h2v1.expression.Format.FormatEnum;
import org.h2v1.expression.Parameter;
import org.h2v1.expression.Rownum;
import org.h2v1.expression.SequenceValue;
import org.h2v1.expression.Subquery;
import org.h2v1.expression.TimeZoneOperation;
import org.h2v1.expression.TypedValueExpression;
import org.h2v1.expression.UnaryOperation;
import org.h2v1.expression.ValueExpression;
import org.h2v1.expression.Variable;
import org.h2v1.expression.Wildcard;
import org.h2v1.expression.aggregate.AbstractAggregate;
import org.h2v1.expression.aggregate.Aggregate;
import org.h2v1.expression.aggregate.AggregateType;
import org.h2v1.expression.aggregate.JavaAggregate;
import org.h2v1.expression.analysis.DataAnalysisOperation;
import org.h2v1.expression.analysis.Window;
import org.h2v1.expression.analysis.WindowFrame;
import org.h2v1.expression.analysis.WindowFrameBound;
import org.h2v1.expression.analysis.WindowFrameBoundType;
import org.h2v1.expression.analysis.WindowFrameExclusion;
import org.h2v1.expression.analysis.WindowFrameUnits;
import org.h2v1.expression.analysis.WindowFunction;
import org.h2v1.expression.analysis.WindowFunctionType;
import org.h2v1.expression.condition.BooleanTest;
import org.h2v1.expression.condition.CompareLike;
import org.h2v1.expression.condition.Comparison;
import org.h2v1.expression.condition.ConditionAndOr;
import org.h2v1.expression.condition.ConditionIn;
import org.h2v1.expression.condition.ConditionInParameter;
import org.h2v1.expression.condition.ConditionInQuery;
import org.h2v1.expression.condition.ConditionLocalAndGlobal;
import org.h2v1.expression.condition.ConditionNot;
import org.h2v1.expression.condition.ExistsPredicate;
import org.h2v1.expression.condition.IsJsonPredicate;
import org.h2v1.expression.condition.NullPredicate;
import org.h2v1.expression.condition.TypePredicate;
import org.h2v1.expression.condition.UniquePredicate;
import org.h2v1.expression.function.Function;
import org.h2v1.expression.function.FunctionCall;
import org.h2v1.expression.function.JavaFunction;
import org.h2v1.expression.function.TableFunction;
import org.h2v1.index.Index;
import org.h2v1.message.DbException;
import org.h2v1.result.SortOrder;
import org.h2v1.schema.Schema;
import org.h2v1.schema.Sequence;
import org.h2v1.table.Column;
import org.h2v1.table.DataChangeDeltaTable;
import org.h2v1.table.DataChangeDeltaTable.ResultOption;
import org.h2v1.table.DualTable;
import org.h2v1.table.FunctionTable;
import org.h2v1.table.IndexColumn;
import org.h2v1.table.IndexHints;
import org.h2v1.table.RangeTable;
import org.h2v1.table.Table;
import org.h2v1.table.TableFilter;
import org.h2v1.table.TableFilter.TableFilterVisitor;
import org.h2v1.table.TableView;
import org.h2v1.util.IntervalUtils;
import org.h2v1.util.ParserUtil;
import org.h2v1.util.StringUtils;
import org.h2v1.util.Utils;
import org.h2v1.util.geometry.EWKTUtils;
import org.h2v1.util.json.JSONItemType;
import org.h2v1.value.CompareMode;
import org.h2v1.value.DataType;
import org.h2v1.value.ExtTypeInfo;
import org.h2v1.value.ExtTypeInfoEnum;
import org.h2v1.value.ExtTypeInfoGeometry;
import org.h2v1.value.TypeInfo;
import org.h2v1.value.Value;
import org.h2v1.value.ValueArray;
import org.h2v1.value.ValueBytes;
import org.h2v1.value.ValueDate;
import org.h2v1.value.ValueDecimal;
import org.h2v1.value.ValueInt;
import org.h2v1.value.ValueInterval;
import org.h2v1.value.ValueJson;
import org.h2v1.value.ValueLong;
import org.h2v1.value.ValueNull;
import org.h2v1.value.ValueRow;
import org.h2v1.value.ValueString;
import org.h2v1.value.ValueTime;
import org.h2v1.value.ValueTimeTimeZone;
import org.h2v1.value.ValueTimestamp;
import org.h2v1.value.ValueTimestampTimeZone;
...
public class Parser {
    ...
    /**
     * @see org.h2v1.engine.DbSettings#databaseToLower
     */
    private final boolean identifiersToLower;
    /**
     * @see org.h2v1.engine.DbSettings#databaseToUpper
     */
