...
import org.h2v1.build.BuildBase;
import org.h2v1.build.doc.BnfRailroad;
import org.h2v1.build.doc.BnfSyntax;
import org.h2v1.build.doc.RailroadImages;
import org.h2v1.server.web.PageParser;
...
public class Railroads {
    ...
    private void processHtml(String fileName) throws Exception {
        String source = "src/tools/org/h2v1/jcr/";
