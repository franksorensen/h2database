...
import org.h2v1.tools.SimpleResultSet.SimpleArray;
...
public class TestTools extends TestDb {
    ...
    private void testJdbcDriverUtils() {
        assertEquals("org.h2v1.Driver", JdbcUtils.getDriver("jdbc:h2:~/test"));
        ...
        try {
            JdbcUtils.getConnection("org.h2v1.Driver", "jdbc:h2x:test", "sa", "");
