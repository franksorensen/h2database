...
import org.h2v1.Driver;
import org.h2v1.engine.Constants;
import org.h2v1.store.fs.FilePathRec;
import org.h2v1.store.fs.FileUtils;
import org.h2v1.test.auth.TestAuthentication;
import org.h2v1.test.bench.TestPerformance;
import org.h2v1.test.db.TestAlter;
import org.h2v1.test.db.TestAlterSchemaRename;
import org.h2v1.test.db.TestAnalyzeTableTx;
import org.h2v1.test.db.TestAutoRecompile;
import org.h2v1.test.db.TestBackup;
import org.h2v1.test.db.TestBigDb;
import org.h2v1.test.db.TestBigResult;
import org.h2v1.test.db.TestCases;
import org.h2v1.test.db.TestCheckpoint;
import org.h2v1.test.db.TestCluster;
import org.h2v1.test.db.TestCompatibility;
import org.h2v1.test.db.TestCompatibilityOracle;
import org.h2v1.test.db.TestCompatibilitySQLServer;
import org.h2v1.test.db.TestCsv;
import org.h2v1.test.db.TestDateStorage;
import org.h2v1.test.db.TestDeadlock;
import org.h2v1.test.db.TestDuplicateKeyUpdate;
import org.h2v1.test.db.TestEncryptedDb;
import org.h2v1.test.db.TestExclusive;
import org.h2v1.test.db.TestFullText;
import org.h2v1.test.db.TestFunctionOverload;
import org.h2v1.test.db.TestFunctions;
import org.h2v1.test.db.TestGeneralCommonTableQueries;
import org.h2v1.test.db.TestIgnoreCatalogs;
import org.h2v1.test.db.TestIndex;
import org.h2v1.test.db.TestIndexHints;
import org.h2v1.test.db.TestLargeBlob;
import org.h2v1.test.db.TestLinkedTable;
import org.h2v1.test.db.TestListener;
import org.h2v1.test.db.TestLob;
import org.h2v1.test.db.TestMemoryUsage;
import org.h2v1.test.db.TestMergeUsing;
import org.h2v1.test.db.TestMultiConn;
import org.h2v1.test.db.TestMultiDimension;
import org.h2v1.test.db.TestMultiThread;
import org.h2v1.test.db.TestMultiThreadedKernel;
import org.h2v1.test.db.TestOpenClose;
import org.h2v1.test.db.TestOptimizations;
import org.h2v1.test.db.TestOptimizerHints;
import org.h2v1.test.db.TestOutOfMemory;
import org.h2v1.test.db.TestPersistentCommonTableExpressions;
import org.h2v1.test.db.TestPowerOff;
import org.h2v1.test.db.TestQueryCache;
import org.h2v1.test.db.TestReadOnly;
import org.h2v1.test.db.TestRecursiveQueries;
import org.h2v1.test.db.TestRights;
import org.h2v1.test.db.TestRowFactory;
import org.h2v1.test.db.TestRunscript;
import org.h2v1.test.db.TestSQLInjection;
import org.h2v1.test.db.TestSelectCountNonNullColumn;
import org.h2v1.test.db.TestSequence;
import org.h2v1.test.db.TestSessionsLocks;
import org.h2v1.test.db.TestSetCollation;
import org.h2v1.test.db.TestSpaceReuse;
import org.h2v1.test.db.TestSpatial;
import org.h2v1.test.db.TestSpeed;
import org.h2v1.test.db.TestSubqueryPerformanceOnLazyExecutionMode;
import org.h2v1.test.db.TestSynonymForTable;
import org.h2v1.test.db.TestTableEngines;
import org.h2v1.test.db.TestTempTables;
import org.h2v1.test.db.TestTransaction;
import org.h2v1.test.db.TestTriggersConstraints;
import org.h2v1.test.db.TestTwoPhaseCommit;
import org.h2v1.test.db.TestUpgrade;
import org.h2v1.test.db.TestUsingIndex;
import org.h2v1.test.db.TestView;
import org.h2v1.test.db.TestViewAlterTable;
import org.h2v1.test.db.TestViewDropView;
import org.h2v1.test.jdbc.TestBatchUpdates;
import org.h2v1.test.jdbc.TestCallableStatement;
import org.h2v1.test.jdbc.TestCancel;
import org.h2v1.test.jdbc.TestConcurrentConnectionUsage;
import org.h2v1.test.jdbc.TestConnection;
import org.h2v1.test.jdbc.TestCustomDataTypesHandler;
import org.h2v1.test.jdbc.TestDatabaseEventListener;
import org.h2v1.test.jdbc.TestDriver;
import org.h2v1.test.jdbc.TestGetGeneratedKeys;
import org.h2v1.test.jdbc.TestJavaObject;
import org.h2v1.test.jdbc.TestJavaObjectSerializer;
import org.h2v1.test.jdbc.TestLimitUpdates;
import org.h2v1.test.jdbc.TestLobApi;
import org.h2v1.test.jdbc.TestManyJdbcObjects;
import org.h2v1.test.jdbc.TestMetaData;
import org.h2v1.test.jdbc.TestNativeSQL;
import org.h2v1.test.jdbc.TestPreparedStatement;
import org.h2v1.test.jdbc.TestResultSet;
import org.h2v1.test.jdbc.TestSQLXML;
import org.h2v1.test.jdbc.TestStatement;
import org.h2v1.test.jdbc.TestTransactionIsolation;
import org.h2v1.test.jdbc.TestUpdatableResultSet;
import org.h2v1.test.jdbc.TestUrlJavaObjectSerializer;
import org.h2v1.test.jdbc.TestZloty;
import org.h2v1.test.jdbcx.TestConnectionPool;
import org.h2v1.test.jdbcx.TestDataSource;
import org.h2v1.test.jdbcx.TestXA;
import org.h2v1.test.jdbcx.TestXASimple;
import org.h2v1.test.mvcc.TestMvcc1;
import org.h2v1.test.mvcc.TestMvcc2;
import org.h2v1.test.mvcc.TestMvcc3;
import org.h2v1.test.mvcc.TestMvcc4;
import org.h2v1.test.mvcc.TestMvccMultiThreaded;
import org.h2v1.test.mvcc.TestMvccMultiThreaded2;
import org.h2v1.test.poweroff.TestReorderWrites;
import org.h2v1.test.recover.RecoverLobTest;
import org.h2v1.test.rowlock.TestRowLocks;
import org.h2v1.test.scripts.TestScript;
import org.h2v1.test.server.TestAutoServer;
import org.h2v1.test.server.TestInit;
import org.h2v1.test.server.TestNestedLoop;
import org.h2v1.test.server.TestWeb;
import org.h2v1.test.store.TestCacheConcurrentLIRS;
import org.h2v1.test.store.TestCacheLIRS;
import org.h2v1.test.store.TestCacheLongKeyLIRS;
import org.h2v1.test.store.TestConcurrent;
import org.h2v1.test.store.TestDataUtils;
import org.h2v1.test.store.TestDefrag;
import org.h2v1.test.store.TestFreeSpace;
import org.h2v1.test.store.TestKillProcessWhileWriting;
import org.h2v1.test.store.TestMVRTree;
import org.h2v1.test.store.TestMVStore;
import org.h2v1.test.store.TestMVStoreBenchmark;
import org.h2v1.test.store.TestMVStoreStopCompact;
import org.h2v1.test.store.TestMVStoreTool;
import org.h2v1.test.store.TestMVTableEngine;
import org.h2v1.test.store.TestObjectDataType;
import org.h2v1.test.store.TestRandomMapOps;
import org.h2v1.test.store.TestSpinLock;
import org.h2v1.test.store.TestStreamStore;
import org.h2v1.test.store.TestTransactionStore;
import org.h2v1.test.synth.TestBtreeIndex;
import org.h2v1.test.synth.TestConcurrentUpdate;
import org.h2v1.test.synth.TestCrashAPI;
import org.h2v1.test.synth.TestDiskFull;
import org.h2v1.test.synth.TestFuzzOptimizations;
import org.h2v1.test.synth.TestHaltApp;
import org.h2v1.test.synth.TestJoin;
import org.h2v1.test.synth.TestKill;
import org.h2v1.test.synth.TestKillRestart;
import org.h2v1.test.synth.TestKillRestartMulti;
import org.h2v1.test.synth.TestLimit;
import org.h2v1.test.synth.TestMultiThreaded;
import org.h2v1.test.synth.TestNestedJoins;
import org.h2v1.test.synth.TestOuterJoins;
import org.h2v1.test.synth.TestRandomCompare;
import org.h2v1.test.synth.TestRandomSQL;
import org.h2v1.test.synth.TestStringAggCompatibility;
import org.h2v1.test.synth.TestTimer;
import org.h2v1.test.synth.sql.TestSynth;
import org.h2v1.test.synth.thread.TestMulti;
import org.h2v1.test.unit.TestAnsCompression;
import org.h2v1.test.unit.TestAutoReconnect;
import org.h2v1.test.unit.TestBinaryArithmeticStream;
import org.h2v1.test.unit.TestBitStream;
import org.h2v1.test.unit.TestBnf;
import org.h2v1.test.unit.TestCache;
import org.h2v1.test.unit.TestCharsetCollator;
import org.h2v1.test.unit.TestClearReferences;
import org.h2v1.test.unit.TestCollation;
import org.h2v1.test.unit.TestCompress;
import org.h2v1.test.unit.TestConnectionInfo;
import org.h2v1.test.unit.TestDataPage;
import org.h2v1.test.unit.TestDate;
import org.h2v1.test.unit.TestDateIso8601;
import org.h2v1.test.unit.TestDateTimeUtils;
import org.h2v1.test.unit.TestDbException;
import org.h2v1.test.unit.TestExit;
import org.h2v1.test.unit.TestFile;
import org.h2v1.test.unit.TestFileLock;
import org.h2v1.test.unit.TestFileLockProcess;
import org.h2v1.test.unit.TestFileSystem;
import org.h2v1.test.unit.TestFtp;
import org.h2v1.test.unit.TestGeometryUtils;
import org.h2v1.test.unit.TestIntArray;
import org.h2v1.test.unit.TestIntIntHashMap;
import org.h2v1.test.unit.TestIntPerfectHash;
import org.h2v1.test.unit.TestInterval;
import org.h2v1.test.unit.TestJmx;
import org.h2v1.test.unit.TestJsonUtils;
import org.h2v1.test.unit.TestKeywords;
import org.h2v1.test.unit.TestLocalResultFactory;
import org.h2v1.test.unit.TestLocale;
import org.h2v1.test.unit.TestMVTempResult;
import org.h2v1.test.unit.TestMathUtils;
import org.h2v1.test.unit.TestMemoryUnmapper;
import org.h2v1.test.unit.TestMode;
import org.h2v1.test.unit.TestModifyOnWrite;
import org.h2v1.test.unit.TestNetUtils;
import org.h2v1.test.unit.TestObjectDeserialization;
import org.h2v1.test.unit.TestOldVersion;
import org.h2v1.test.unit.TestOverflow;
import org.h2v1.test.unit.TestPageStore;
import org.h2v1.test.unit.TestPageStoreCoverage;
import org.h2v1.test.unit.TestPattern;
import org.h2v1.test.unit.TestPerfectHash;
import org.h2v1.test.unit.TestPgServer;
import org.h2v1.test.unit.TestReader;
import org.h2v1.test.unit.TestRecovery;
import org.h2v1.test.unit.TestReopen;
import org.h2v1.test.unit.TestSampleApps;
import org.h2v1.test.unit.TestScriptReader;
import org.h2v1.test.unit.TestSecurity;
import org.h2v1.test.unit.TestShell;
import org.h2v1.test.unit.TestSort;
import org.h2v1.test.unit.TestStreams;
import org.h2v1.test.unit.TestStringCache;
import org.h2v1.test.unit.TestStringUtils;
import org.h2v1.test.unit.TestTimeStampWithTimeZone;
import org.h2v1.test.unit.TestTools;
import org.h2v1.test.unit.TestTraceSystem;
import org.h2v1.test.unit.TestUtils;
import org.h2v1.test.unit.TestValue;
import org.h2v1.test.unit.TestValueMemory;
import org.h2v1.test.utils.OutputCatcher;
import org.h2v1.test.utils.SelfDestructor;
import org.h2v1.test.utils.TestColumnNamer;
import org.h2v1.tools.DeleteDbFiles;
import org.h2v1.tools.Server;
import org.h2v1.util.AbbaLockingDetector;
import org.h2v1.util.Profiler;
import org.h2v1.util.StringUtils;
import org.h2v1.util.Task;
import org.h2v1.util.ThreadDeadlockDetector;
...
--reportDir data --targetClasses org.h2v1.dev.store.btree.StreamStore*
--targetTests org.h2v1.test.store.TestStreamStore
...
del *.db
start cmd /k "java -cp .;%H2DRIVERS% org.h2v1.test.TestAll join >testJoin.txt"
start cmd /k "java -cp . org.h2v1.test.TestAll synth >testSynth.txt"
start cmd /k "java -cp . org.h2v1.test.TestAll all >testAll.txt"
start cmd /k "java -cp . org.h2v1.test.TestAll random >testRandom.txt"
start cmd /k "java -cp . org.h2v1.test.TestAll btree >testBtree.txt"
start cmd /k "java -cp . org.h2v1.test.TestAll halt >testHalt.txt"
java -cp . org.h2v1.test.TestAll crash >testCrash.txt

java org.h2v1.test.TestAll timer
...
reopen org.h2v1.test.unit.TestPageStore
...
kill a test:
kill -9 `jps -l | grep "org.h2v1.test." | cut -d " " -f 1`
...
*/
    ...
    private void testAdditional() {
        ...
        addTest(createTest("org.h2v1.test.unit.TestServlet"));
