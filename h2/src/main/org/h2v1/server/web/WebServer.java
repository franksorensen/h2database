...
import org.h2v1.server.Service;
import org.h2v1.server.ShutdownHandler;
...
public class WebServer implements Service {
    ...
    private static final String[] GENERIC = {
        ...
        "Generic H2 (Server)|org.h2v1.Driver|" +
                "jdbc:h2:tcp://localhost/~/test|sa",
        // this will be listed on top for new installations
        "Generic H2 (Embedded)|org.h2v1.Driver|" +
                "jdbc:h2:~/test|sa",
    };
...
//                // "src/main/org/h2v1/server/web/res/_text_cs.prop"), -1);
//                "src/main/org/h2v1/res/_messages_cs.prop"), -1);
...
//    }
    ...
    byte[] getFile(String file) throws IOException {
        trace("getFile <" + file + ">");
        byte[] data = Utils.getResource("/org/h2v1/server/web/res/" + file);
        if (data == null) {
            trace(" null");
        } else {
