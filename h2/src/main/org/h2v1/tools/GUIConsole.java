...
public class GUIConsole extends Console implements ActionListener, MouseListener, WindowListener {
    ...
    private boolean createTrayIcon() {
        try {
            ...
            if (d.width >= 24 && d.height >= 24) {
                iconFile = "/org/h2v1/res/h2-24.png";
                ...
                iconFile = "/org/h2v1/res/h2-64-t.png";
                // iconFile = "/org/h2v1/res/h2-22-t.png";
            } else {
                iconFile = "/org/h2v1/res/h2.png";
            }
    ...
    private void showStatusWindow() {
        ...
        Image image = loadImage("/org/h2v1/res/h2.png");
        if (image != null) {
