 ...
 */
package org.h2v1.test.synth.sql;
...
public class TestSynth extends TestDb {
    ...
    public TestBase init(TestAll conf) throws Exception {
        ...
        // addDatabase("org.h2v1.Driver", "jdbc:h2:synth;mode=hsqldb", "sa", "");

        // mode = POSTGRESQL;
        // addDatabase("org.postgresql.Driver", "jdbc:postgresql:test", "sa",
        // "sa");
        // addDatabase("org.h2v1.Driver", "jdbc:h2:synth;mode=postgresql", "sa",
        // "");

        mode = H2_MEM;
        org.h2v1.Driver.load();
        addDatabase("org.h2v1.Driver", "jdbc:h2:mem:synth", "sa", "", true);
        addDatabase("org.h2v1.Driver", "jdbc:h2:" +
                getBaseDir() + "/synth/synth", "sa", "", false);

        // addDatabase("com.mysql.jdbc.Driver", "jdbc:mysql://localhost/test",
        // "sa", "");
        // addDatabase("org.h2v1.Driver", "jdbc:h2:synth;mode=mysql", "sa", "");

        // addDatabase("com.mysql.jdbc.Driver", "jdbc:mysql://localhost/test",
        // "sa", "");
        // addDatabase("org.ldbc.jdbc.jdbcDriver",
        // "jdbc:ldbc:mysql://localhost/test", "sa", "");
        // addDatabase("org.h2v1.Driver", "jdbc:h2:memFS:synth", "sa", "");
