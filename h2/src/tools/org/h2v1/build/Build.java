...
import org.h2v1.build.doc.XMLParser;
...
public class Build extends BuildBase {
    ...
    public void benchmark() {
        ...
        StringList args = args("-Xmx128m",
                "-cp", cp, "org.h2v1.test.bench.TestPerformance");
    ...
    private void compileTools() {
        mkdir("temp");
        FileList files = files("src/tools").keep("src/tools/org/h2v1/build/*");
    ...
    public void coverage() {
        ...
        execJava(args(
                ...
                "-javaagent:ext/jacocoagent.jar=destfile=coverage/jacoco.exec,"
                        + "excludes=org.h2v1.test.*:org.h2v1.tools.*:org.h2v1.sample.*",
                "-cp", cp,
                "org.h2v1.test.TestAll", "codeCoverage"));
        // Remove classes that we don't want to include in report
        delete(files("coverage/bin/org/h2v1/test"));
        delete(files("coverage/bin/org/h2v1/tools"));
        delete(files("coverage/bin/org/h2v1/sample"));
        // Generate report
        execJava(args("-cp",
    ...
    private void compileMVStore(boolean debugInfo) {
        ...
        FileList files;
        files = files("src/main/org/h2v1/mvstore").
                exclude("src/main/org/h2v1/mvstore/db/*");
    ...
    private void compile(boolean debugInfo, boolean clientOnly,
        ...
        FileList files;
        if (clientOnly) {
            files = files("src/main/org/h2v1/Driver.java");
            files.addAll(files("src/main/org/h2v1/jdbc"));
            files.addAll(files("src/main/org/h2v1/jdbcx"));
        } else {
        ...
        if (!clientOnly) {
            ...
            files = files.exclude("src/test/org/h2v1/test/TestAllJunit.java");
    ...
    public void docs() {
        ...
        java("org.h2v1.build.doc.XMLChecker", null);
        java("org.h2v1.build.code.CheckJavadoc", null);
        java("org.h2v1.build.code.CheckTextFiles", null);
        java("org.h2v1.build.doc.GenerateDoc", null);
        java("org.h2v1.build.doc.GenerateHelp", null);
        java("org.h2v1.build.indexer.Indexer", null);
        java("org.h2v1.build.doc.MergeDocs", null);
        java("org.h2v1.build.doc.WebSite", null);
        java("org.h2v1.build.doc.LinkChecker", null);
        java("org.h2v1.build.doc.XMLChecker", null);
        java("org.h2v1.build.doc.SpellChecker", null);
        java("org.h2v1.build.code.CheckTextFiles", null);
        beep();
    }
    ...
    private void downloadTest() {
        ...
        // for TestOldVersion
        downloadUsingMaven("ext/h2v1-1.2.127.jar",
    ...
    private static String getVersion() {
        return getStaticField("org.h2v1.engine.Constants", "VERSION");
    }
    ...
    public void installer() {
        ...
        String buildDate = getStaticField("org.h2v1.engine.Constants", "BUILD_DATE");
        byte[] data = readFile(new File("../h2web/h2.zip"));
        String sha1Zip = getSHA1(data), sha1Exe = null;
        writeFile(new File("../h2web/h2v1-" + buildDate + ".zip"), data);
        if (installer) {
            data = readFile(new File("../h2web/h2v1-setup.exe"));
            sha1Exe = getSHA1(data);
            writeFile(new File("../h2web/h2v1-setup-" + buildDate + ".exe"), data);
        }
    ...
    public void jar() {
        ...
        FileList files = files("temp").
            exclude("temp/org/h2v1/build/*").
            exclude("temp/org/h2v1/dev/*").
            exclude("temp/org/h2v1/jcr/*").
            exclude("temp/org/h2v1/java/*").
            exclude("temp/org/h2v1/jcr/*").
            exclude("temp/org/h2v1/samples/*").
            exclude("temp/org/h2v1/server/ftp/*").
            exclude("temp/org/h2v1/test/*").
            exclude("*.bat").
            exclude("*.sh").
            exclude("*.txt").
            exclude("*.DS_Store");
        files = excludeTestMetaInfFiles(files);
        jar("bin/h2v1" + getJarSuffix(), files, "temp");
        filter("src/installer/h2v1.sh", "bin/h2v1.sh", "h2v1.jar", "h2v1" + getJarSuffix());
        filter("src/installer/h2v1.bat", "bin/h2v1.bat", "h2v1.jar", "h2v1" + getJarSuffix());
        filter("src/installer/h2v1w.bat", "bin/h2v1w.bat", "h2v1.jar", "h2v1" + getJarSuffix());
    }
    ...
    public void jarClient() {
        ...
        FileList files = files("temp").
            ...
            exclude("*.DS_Store");
        files = excludeTestMetaInfFiles(files);
        long kb = jar("bin/h2v1-client" + getJarSuffix(), files, "temp");
        if (kb < 400 || kb > 600) {
    ...
    public void jarMVStore() {
        ...
        files = excludeTestMetaInfFiles(files);
        jar("bin/h2v1-mvstore" + getJarSuffix(), files, "temp");
    }
    ...
    public void jarSmall() {
        ...
        FileList files = files("temp").
            ...
            exclude("temp/org/h2v1/server/ftp/*").
            exclude("temp/org/h2v1/test/*").
            exclude("temp/org/h2v1/bnf/*").
            exclude("temp/org/h2v1/fulltext/*").
            exclude("temp/org/h2v1/jdbcx/*").
            exclude("temp/org/h2v1/jmx/*").
            exclude("temp/org/h2v1/server/*").
            exclude("temp/org/h2v1/tools/*").
            exclude("*.bat").
            exclude("*.sh").
            exclude("*.txt").
            exclude("*.DS_Store");
        files = excludeTestMetaInfFiles(files);
        files.add(new File("temp/org/h2v1/tools/DeleteDbFiles.class"));
        files.add(new File("temp/org/h2v1/tools/CompressTool.class"));
    ...
    public void javadoc() {
        ...
        delete("docs");
        mkdir("docs/javadoc");
        javadoc("-sourcepath", "src/main", "org.h2v1.jdbc", "org.h2v1.jdbcx",
                "org.h2v1.tools", "org.h2v1.api", "org.h2v1.engine", "org.h2v1.fulltext",
                "-classpath",
                ...
                "-doclet", "org.h2v1.build.doclet.Doclet");
    ...
    public void javadocImpl() {
        ...
        javadoc("-sourcepath", "src/main",
                ...
                File.pathSeparator + "ext/org.osgi.enterprise-4.2.0.jar" +
                File.pathSeparator + "ext/jts-core-1.15.0.jar",
                "-subpackages", "org.h2v1.mvstore",
                "-exclude", "org.h2v1.mvstore.db");
    ...
    public void mavenDeployCentral() {
        ...
        jar("docs/h2v1-" + getVersion() + "-sources.jar", files, "docs");
        delete("docs/org");
        ...
        execScript("mvn", args(
                "deploy:deploy-file",
                "-Dfile=docs/h2v1-" + getVersion() + "-sources.jar",
        ...
        jar("docs/h2v1-" + getVersion() + "-javadoc.jar", files, "docs/javadocImpl2");
        execScript("mvn", args(
                "deploy:deploy-file",
                "-Dfile=docs/h2v1-" + getVersion() + "-javadoc.jar",
                "-Durl=file:///data/h2database/m2-repo",
                "-Dpackaging=jar",
                "-Dclassifier=javadoc",
                "-Dversion=" + getVersion(),
        ...
        // generate the h2v1-mvstore-*-sources.jar file
        files = files("src/main");
        copy("docs", files, "src/main");
        files = files("docs").keep("docs/org/h2v1/mvstore/*").
                exclude("docs/org/h2v1/mvstore/db/*").
                keep("*.java");
        files.addAll(files("docs").keep("docs/META-INF/*"));
        ...
        manifest = replaceAll(manifest, "${version}", getVersion());
        writeFile(new File("docs/META-INF/MANIFEST.MF"), manifest.getBytes());
        jar("docs/h2v1-mvstore-" + getVersion() + "-sources.jar", files, "docs");
        delete("docs/org");
        delete("docs/META-INF");

        // deploy the h2v1-mvstore-*-source.jar file
        execScript("mvn", args(
                "deploy:deploy-file",
                "-Dfile=docs/h2v1-mvstore-" + getVersion() + "-sources.jar",
                "-Durl=file:///data/h2database/m2-repo",
                "-Dpackaging=jar",
                "-Dclassifier=sources",
                "-Dversion=" + getVersion(),
                "-DartifactId=h2v1-mvstore",
                "-DgroupId=com.h2database"
                // ,"-DgeneratePom=false"
                ));

        // generate and deploy the h2v1-mvstore-*-javadoc.jar file
        javadocImpl();
        files = files("docs/javadocImpl3");
        jar("docs/h2v1-mvstore-" + getVersion() + "-javadoc.jar", files, "docs/javadocImpl3");
        execScript("mvn", args(
                "deploy:deploy-file",
                "-Dfile=docs/h2v1-mvstore-" + getVersion() + "-javadoc.jar",
                "-Durl=file:///data/h2database/m2-repo",
                "-Dpackaging=jar",
                "-Dclassifier=javadoc",
                "-Dversion=" + getVersion(),
        ...
        // generate and deploy the h2v1-mvstore-*.jar file
        jarMVStore();
        ...
        execScript("mvn", args(
                "deploy:deploy-file",
                "-Dfile=bin/h2v1-mvstore" + getJarSuffix(),
                "-Durl=file:///data/h2database/m2-repo",
                "-Dpackaging=jar",
                "-Dversion=" + getVersion(),
                "-DpomFile=bin/pom.xml",
    ...
    private void resources(boolean clientOnly, boolean basicOnly) {
        if (!clientOnly) {
            java("org.h2v1.build.doc.GenerateHelp", null);
            javadoc("-sourcepath", "src/main", "org.h2v1.tools", "org.h2v1.jmx",
                    "-classpath",
                    "ext/lucene-core-5.5.5.jar" +
                    File.pathSeparator + "ext/lucene-analyzers-common-5.5.5.jar" +
                    File.pathSeparator + "ext/lucene-queryparser-5.5.5.jar" +
                    File.pathSeparator + "ext/jts-core-1.15.0.jar",
                    "-docletpath", "bin" + File.pathSeparator + "temp",
                    "-doclet", "org.h2v1.build.doclet.ResourceDoclet");
        }
        FileList files = files("src/main").
            exclude("*.MF").
            exclude("*.java").
            ...
            exclude("*.DS_Store");
        if (basicOnly) {
            files = files.keep("src/main/org/h2v1/res/_messages_en.*");
        }
        if (clientOnly) {
            files = files.exclude("src/main/org/h2v1/res/help.csv");
            files = files.exclude("src/main/org/h2v1/res/h2*");
            files = files.exclude("src/main/org/h2v1/res/javadoc.properties");
            files = files.exclude("src/main/org/h2v1/server/*");
        }
        zip("temp/org/h2v1/util/data.zip", files, "src/main", true, false);
    }
    ...
    private void test(boolean travis) {
        ...
        if (travis) {
            ret = execJava(args(
                    ...
                    "-cp", cp,
                    "org.h2v1.test.TestAll", "travis"));
        } else {
            ret = execJava(args(
                    "-ea",
                    "-Xmx128m",
                    "-cp", cp,
                    "org.h2v1.test.TestAll"));
        }
    ...
    public void uploadBuild() {
        ...
        execJava(args("-Xmx512m", "-cp", cp,
                ...
                "org.h2v1.build.doc.UploadBuild"));
    }
